...
if __name__ == '__main__':
    ...
    eddy_select_info['outfile']='D:/DATA/SLA/eddy/2022/'  #D:\Data\SLA\eddy\2023
...
#    #获取不同分块的经纬度范围
#    for mon in mons:
    inputdirectory='D:\\Data\\SLA\\2022\\done\\'#'E:\\Data\\SLA\\all-sat-nc\\2022\\'#+mon+'\\'#'D:/SLA/04/'
    AVISO_files =glob.glob(inputdirectory+'*.nc')  
    #识别不同时间的涡旋
    #for AVISO_file in AVISO_files: 
    for k in range (120,121): #len(AVISO_files)
