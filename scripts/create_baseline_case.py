...
def build_case_config(args: argparse.Namespace, preset: Dict[str, Any]) -> str:
    ...
    legacy_output_dir = case_dir / "original_output"
    return f"""# Baseline case config generated by scripts/create_baseline_case.py
# This file documents the case and can be passed to scripts/prepare_detection_run.py.
...
output:
  # This satisfies the shared config validator and maps to legacy eddy_select_info['outfile'].
  # The legacy algorithm will create dated subdirectories under this path when executed.
  output_dir: {yaml_scalar(str(legacy_output_dir))}
  write_json: true
